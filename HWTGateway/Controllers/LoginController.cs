using HWTGateway.ViewModel.HomeVMs;
...
namespace HWTGateway.Controllers
{
    [AllRights]
    public class LoginController : BaseController
    {
        ...
        public IActionResult Login()
        {
            ...
            {
                vm.ITCode = "admin";
                //vm.Password = "HWTGateway.net";
                vm.Password = "hzwaterit.cn";
            }
            return View(vm);
        }
        ...
        {
            if (!ValidateVerifyCode(vm.VerifyCode))
            {
        ...
        {
            if (Wtm.ConfigInfo.IsQuickDebug)
            {
                return true;
            }
