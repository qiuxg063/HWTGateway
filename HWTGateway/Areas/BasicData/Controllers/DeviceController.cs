using HWTGateway.ViewModel.BasicData;
using HWTGateway.ViewModel.BasicData.DeviceVMs;
...
namespace HWTGateway.Controllers
{
    ...
    public partial class DeviceController : BaseController
    {
        ...
        public IActionResult ExportExcel(DeviceListVM vm)
        {
            ...
            string exportName = $"HWTGateway.net_bakup_{DateTime.Now.ToString("yyyyMMddHHmmssffff")}.xlsx";
