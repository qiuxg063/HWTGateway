...
namespace HWTGateway.DataAccess
{
        ...
        public override async Task<bool> DataInit(object allModules, bool IsSpa)
        {
            ...
            if (state == true || emptydb == true)
            {
                ...
                var user = new FrameworkUser
                {
                    ...
                    //modified by qxg
                    //Password = Utils.GetMD5String("HWTGateway.net"),
                    Password = Utils.HashPassword("hzwaterit.cn"),
    ...
    public class DataContextFactory : IDesignTimeDbContextFactory<DataContext>
    {
        ...
        {
            return new DataContext("Data Source = ../HWTGateway/data/HWTGateway.db", DBTypeEnum.SQLite);
        }
    }
}